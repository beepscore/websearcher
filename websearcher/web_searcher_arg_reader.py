...
class WebSearcherArgReader:
    ...
    def args(self, commandline=None):
        ...
        parser.add_argument('-out_file', action="store", dest="out_file", default="../websearcher_results/websearcher_results.txt",
                            help='name of output file. Default "../websearcher_results/websearcher_results.txt"'
                            )
